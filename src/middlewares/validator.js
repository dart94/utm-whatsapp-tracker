...
const validateRedirect = [
  ...
  query("fbclid")
    ...
    .trim()
    .isLength({ max: 200 })
    .withMessage("fbclid must be less than 200 characters"),

  query("gclid")
    .optional()
    .trim()
    .isLength({ max: 200 })
    .withMessage("gclid must be less than 200 characters"),
...
const validateUpdateCampaign = [
  param("id").trim().notEmpty().withMessage("Campaign ID is required"),
